import { ReplyIcon, VolumeOffIcon } from "@heroicons/react/outline";
import { FastForwardIcon, PauseIcon, PlayIcon, RewindIcon, SwitchHorizontalIcon, VolumeUpIcon } from "@heroicons/react/solid";
  ...
  return (
    ...
    md:text-base px-2 md:px-8">
     ...
     md:space-x-4 justify-end pr-5">
        ...
        <VolumeUpIcon onClick={() => volume < 100 && setVolume + 10} className="button" />
     </div>
    </div>
  )
}
